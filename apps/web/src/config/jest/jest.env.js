...
process.env.CONTENTFUL_PAGE_ENTRY_ID = 'page-entry-id'
process.env.CONTENTFUL_BPOR_FOOTER_ENTRY_ID = 'bpor-footer-entry-id'
process.env.CONTENTFUL_PAGE_STUDY_ASSESS_ID = 'Study-asses-entry-id'
process.env.CONTENTFUL_PAGE_UPDATE_STUDY_ID = 'study-update-entry-id'
...
process.env.AWS_SECRET_NAME = 'secret_name'
