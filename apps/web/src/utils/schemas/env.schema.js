...
const envSchema = z
  .object({
    ...
    CONTENTFUL_PAGE_ENTRY_ID: z.string(),
    CONTENTFUL_BPOR_FOOTER_ENTRY_ID: z.string(),
...
const validateEnv = () => {
  const result = envSchema.safeParse({
    ...
    CONTENTFUL_PAGE_ENTRY_ID: process.env.CONTENTFUL_PAGE_ENTRY_ID,
    CONTENTFUL_BPOR_FOOTER_ENTRY_ID: process.env.CONTENTFUL_BPOR_FOOTER_ENTRY_ID,
