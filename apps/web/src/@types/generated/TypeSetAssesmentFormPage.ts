...
/**
 * Entry skeleton type definition for content type 'setAssesmentFormPage' (SET assessment form page)
...
/**
 * Entry type definition for content type 'setAssesmentFormPage' (SET assessment form page)
